...
export const metadata = {
    title: 'About us | Outstanding Cleaning Services',
    description:
                    ...
                    <div className="container">
                        <div className="lg:w-8/12">
                            <div className="section-heading mb-4 lg:mb-10">
                                <PrismicRichText
                                    field={whychooseLeft.primary.heading}
                                />
                            </div>
                            <PrismicRichText
                                field={whychooseLeft.primary.text}
                            />
                        </div>
